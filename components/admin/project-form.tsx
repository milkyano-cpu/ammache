...
export function ProjectForm({ mode, categories, initialData }: ProjectFormProps) {
        ...
        <TabsContent value="specifications" className="space-y-4 mt-4">
          <div className="space-y-2">
            ...
            <p className="text-sm text-gray-500">
              Add key-value pairs for project specifications
            </p>
            <SpecificationEditor
        ...
        <TabsContent value="seo" className="space-y-4 mt-4">
          ...
          <div className="border rounded-lg p-4 bg-gray-50 space-y-1">
            ...
            <p className="text-blue-700 text-lg font-medium truncate">
              {metaTitle || name || "Project Name"}
            </p>
            <p className="text-green-700 text-sm">
              ammache.com/project/{slug || "project-slug"}
            </p>
            <p className="text-sm text-gray-600 line-clamp-2">
              {metaDescription || shortDescription || "Project description will appear here..."}
            </p>
          </div>
        </TabsContent>
      </Tabs>
