        ...
        <div className="bg-white rounded-[30px] shadow-[0_30px_80px_rgba(0,0,0,0.08)] p-8 md:p-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                className="w-full px-6 py-4 text-[16px] md:text-[17px] rounded-lg border border-gray-200 focus:outline-none focus:ring-1 focus:ring-black/20"
            ...
            <div>
              ...
              <div className="flex border border-gray-200 rounded-lg overflow-hidden">
                <select className="px-4 text-[16px] border-r border-gray-200">
                  <option>US</option>
                  <option>ID</option>
                </select>
                <input
                  className="flex-1 px-6 py-4 text-[16px]"
            ...
            <div>
              ...
              <select className="w-full px-6 py-4 text-[16px] md:text-[17px] rounded-lg border border-gray-200">
            ...
            <div>
              ...
              <input
                className="w-full px-6 py-4 text-[16px] md:text-[17px] rounded-lg border border-gray-200"
            ...
            <div>
              ...
              <textarea
                rows={5}
                className="w-full px-6 py-4 text-[16px] md:text-[17px] rounded-lg border border-gray-200 resize-none"
            ...
            {/* CHECKBOX */}
            <div className="space-y-4 text-[18px] text-black mt-6">
            ...
            {/* BUTTON */}
            <button className="w-full mt-8 py-4 bg-black text-white rounded-lg font-medium hover:bg-gray-800 transition cursor-pointer">
              Submit Enquiry
            </button>
