            ...
            <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                ...
                <div className="space-y-4 md:space-y-6">
                    ...
                    <p className="typo-body-lg text-gray-900 max-w-md text-justify">
                        Beyond the studio, we've spent decades building relationships with the people who shape the built
                        environment architects, developers, builders, and designers who care about more than just construction.
                        <br /><br />
